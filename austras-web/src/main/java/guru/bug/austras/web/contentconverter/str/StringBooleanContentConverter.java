...
public class StringBooleanContentConverter implements BooleanContentConverter {
    private final StringBooleanConverter booleanConverter;

    public StringBooleanContentConverter(StringBooleanConverter booleanConverter) {
